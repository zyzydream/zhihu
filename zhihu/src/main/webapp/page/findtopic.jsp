...
<body class="zhi ">
				...
				<div class="zg-section" id="zh-home-list-title">
					<div class="row">
						<div class="col-sm-8 blog-main" style="width: 640px;">
							<span style="width: 640px; margin-bottom: 5px;" id="introduction">
								<!-- <span class="glyphicon glyphicon-th-list" aria-hidden="true"
								style="float: left; margin-right: 5px;"></span> -->
								<div class="page-header" style="margin: 0px; width: 640px;">
									<div class="row">
										<div class="col-xs-6 col-md-3"
											style="width: 50px;height:50px; margin: 8px; padding: 0px;float: left;">
	...
	<script type="text/javascript" src="js/findtopic.js"></script>
</body>
</html>