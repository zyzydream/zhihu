		...
		<div class="AppHeader-inner">
			...
			<div class="AppHeader-userInfo">
				...
				<div class="AppHeader-profile">
					<div class="Popover">
						<a id="Popover-21677-9959-toggle"
							class="Button AppHeader-profileEntry Button--plain" type="button"
							href="page/myself.jsp"> <img class="Avatar"
				...
				<div class="totalinfos">
					<table class="table table-striped"
						...
						<tr>
							...
							<td class="info"><%=request.getSession().getAttribute("myattentop2")%></td>
						</tr>
						<tr>
							<td class="info">关注的专题</td>
							<td class="info"><%=request.getSession().getAttribute("myattenzhuanti2")%></td>
						</tr>
						<tr>
							<td class="info">关注的收藏夹</td>
							<td class="info"><%=request.getSession().getAttribute("myattenfav2")%></td>
						</tr>
					</table>
				</div>
				<div class="panel panel-default"
					...
					<div class="panel-body">
						...
						<ul class="list-inline">
							<li
								style="padding-left: 40px; padding-top: 10px; text-align: center"><%=request.getSession().getAttribute("myatten2")%></li>
							<li
								style="padding-left: 120px; padding-top: 10px; text-align: center"><%=request.getSession().getAttribute("attenme2")%></li>
						</ul>
					</div>
				</div>
			</div>
