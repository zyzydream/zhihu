...
$.get("user/dynstate",function(data){
	...
	for(var i=0;i<data.length;i++){
		...
		if(data[i].kind=="W"){
			...
			dynstate+='<div class="row featurette"><div class="col-md-7">';
			dynstate+='<h2 class="featurette-heading" style="font-size: 20px;"><span class="text-muted" style="font-size: 15px">'+data[i].author+':发表文章：</span><br />'+data[i].tname+'</h2>';
			dynstate+='<p class="lead" style="font-size: 14px;">'+data[i].content+'</p>';
			dynstate+='<span><a href="#" style="font-size: 13px;font-weight: 40">阅览 <span class="badge" style="width: 20px;padding: 0px;">42</span></a>';
			dynstate+='<a href="#" style="font-size: 13px;font-weight: 40">点赞 <span class="badge" style="width: 20px;padding: 0px;">42</span></a>';
			dynstate+='<a href="#" style="font-size: 13px;font-weight: 40">收藏 <span class="badge" style="width: 20px;padding: 0px;">42</span></a></span>';
